...
class StatsManager:
    ...
    def print_stats(cls, cards: List[dict], full_text: bool = False) -> None:
        ...
        for i, c in enumerate(cards):
            ...
            t.add_row([i, c.get_question(full_text), c.get_answer(), c.repeats, c.correct_repeats, success_percent_colored, was_answered_wrong_lately, c.last_appearance_date])
